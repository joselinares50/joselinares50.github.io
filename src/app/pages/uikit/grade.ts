...
@Component({
    ...
    template: `
        ...
        <div class="card">
            ...
            <p-table [value]="grouping" showGridlines sortField="category" sortMode="single" [scrollable]="true" scrollHeight="1000px" rowGroupMode="subheader" groupRowsBy="category" [tableStyle]="{ 'min-width': '60rem' , 'min-height': '30rem'}">
                <ng-template #header>
                    <tr>
                        <th>Category</th>
                        <th>Name</th>
